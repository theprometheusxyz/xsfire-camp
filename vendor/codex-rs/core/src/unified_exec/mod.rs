...
#[async_trait]
pub trait UnifiedExecDelegate: Send + Sync {
...
pub type UnifiedExecDelegateFactory =
    Arc<dyn Fn(ThreadId) -> Arc<dyn UnifiedExecDelegate> + Send + Sync>;
...
pub struct UnifiedExecProcessManager {
    delegate: Option<Arc<dyn UnifiedExecDelegate>>,
...
impl UnifiedExecProcessManager {
    pub fn new(delegate: Option<Arc<dyn UnifiedExecDelegate>>) -> Self {
        Self {
            delegate,
